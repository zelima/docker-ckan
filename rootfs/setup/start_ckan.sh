...
UWSGI_OPTS="--plugins http,python,gevent --socket /tmp/uwsgi.sock --uid 92 --gid 92 --http :4000 --master --enable-threads --paste config:/srv/app/production.ini --lazy-apps --gevent 2000 -p 2"
